...
exports.getSCSSRegionsDocument = exports.getVueSCSSContent = exports.getVueSCSSRegions = exports.isVueFile = void 0;
...
function convertVueTextDocument(document, regions) {
    return vscode_languageserver_textdocument_1.TextDocument.create(document.uri, 'scss', document.version, getVueSCSSContent(document.getText(), regions));
}
